        ...
        questions: [
          {
            id: "q01",
            question:
              "What is the time complexity of brute force approach of Two Sum problem?",
          ...
          },
          {
            id: "q02",
            question:
              "What is the time complexity of Two Sum problem using hash map?",
            options: ["O(n^2)", "O(n)", "O(log n)", "O(1)"],
            correctAnswer: "O(n)",
          },
          {
        ...
        questions: [
          {
            id: "q01",
            question:
              "What is the best way to represent a linked list in a programming language?",
            options: ["Array", "HashMap", "Node-based structure", "Stack"],
          ...
          },
          {
            id: "q03",
            question:
              "What is the maximum number of nodes that could exist in the linked lists based on the given constraints?",
            options: ["100", "10^6", "1", "1000"],
            correctAnswer: "100",
          },
          {
            id: "q04",
        ...
        questions: [
          {
            id: "q01",
            question:
              "What is the time complexity of the optimal solution for finding the longest substring without repeating characters?",
          ...
          },
          {
            id: "q02",
            question:
              "Which data structure is commonly used to track characters in the substring for this problem?",
          ...
          },
          {
            id: "q03",
            question:
              "What is the maximum possible length of the input string based on the constraints?",
          ...
          },
          {
            id: "q04",
            question:
              "Which sliding window technique is most suitable for solving this problem efficiently?",
            options: [
              "Fixed window",
        ...
        questions: [
          {
            id: "q01",
            question:
              "What is the time complexity of the optimal solution for finding the median of two sorted arrays?",
          ...
          },
          {
            id: "q02",
            question:
              "Which method is typically used to find the median of two sorted arrays efficiently?",
            options: [
              "Binary Search",
              "Linear Search",
              "Divide and Conquer",
          ...
          },
          {
            id: "q03",
            question:
              "What is the maximum possible value for the sum of m and n based on the given constraints?",
          ...
          },
          {
            id: "q04",
            question:
              "What is the range of possible values for elements in nums1 and nums2?",
            options: [
              "-10^6 to 10^6",
              "-10^9 to 10^9",
              "-10^3 to 10^3",
      ...
      quiz: {
        ...
        questions: [
          ...
          },
          {
            id: "q02",
            question:
              "Which algorithm can be used to find the longest palindromic substring in linear time?",
            options: [
              "KMP Algorithm",
          ...
          },
          {
            id: "q04",
            question:
              "Which technique is commonly used in a dynamic programming solution for this problem?",
            options: [
        ...
        questions: [
          {
            id: "q01",
            question:
              "What is the time complexity of the ZigZag conversion algorithm?",
          ...
          },
          {
            ...
            options: [
              "Vertically down then diagonally up",
              "Vertically down then up",
          ...
          },
          {
            id: "q03",
            question:
              "What is the maximum length of the string 's' based on the constraints?",
          ...
          },
          {
            id: "q04",
            question:
              "What happens if the number of rows is 1 in the ZigZag conversion?",
            options: [
        ...
        questions: [
          {
            id: "q01",
            question:
              "What is the time complexity of reversing the digits of an integer?",
            options: ["O(n)", "O(log n)", "O(n^2)", "O(1)"],
          ...
          },
          {
            id: "q02",
            question:
              "What should be returned if the reversed integer exceeds the 32-bit signed integer range?",
            options: [
          ...
          },
          {
            id: "q03",
            question:
              "What is the maximum positive value for a 32-bit signed integer?",
          ...
          },
          {
            id: "q04",
            question:
              "How does the algorithm handle leading zeros in the reversed integer?",
            options: [
              "They are ignored",
              "They are added back",
              "They cause an error",
        ...
        questions: [
          {
            id: "q01",
            question:
              "What is the primary challenge in implementing the atoi function?",
            options: [
              "Handling spaces",
          ...
          },
          {
            id: "q02",
            question:
              "What should the atoi function return if the string contains non-numeric characters before any digits?",
          ...
          },
          {
            id: "q03",
            question:
              "How does atoi handle strings that exceed the 32-bit signed integer range?",
            options: [
              "Returns the maximum/minimum 32-bit signed integer",
              "Returns 0",
              "Returns an error",
          ...
          },
          {
            id: "q04",
            question:
              "What is the maximum length of the string 's' according to the constraints?",
        ...
        questions: [
          {
            id: "q01",
            question:
              "What is the time complexity of checking if an integer is a palindrome?",
          ...
          },
          {
            id: "q02",
            question:
              "What is a key characteristic of a number that makes it not a palindrome?",
            options: [
          ...
          },
          {
            id: "q04",
            question:
              "How does the algorithm handle negative integers when checking for palindromes?",
            options: [
              "Considers them as non-palindromes",
              "Converts them to positive",
              "Ignores the negative sign",
              "Handles them as normal integers",
            ],
        ...
        questions: [
          {
            id: "q01",
            question:
              "What does the '*' character represent in regular expressions?",
            options: [
          ...
          },
          {
            id: "q02",
            question:
              "How does the '.' character function in regular expressions?",
            options: [
          ...
          },
          {
            id: "q03",
            question:
              "What is the maximum length for the input string 's' according to the constraints?",
            options: ["10", "20", "30", "40"],
            correctAnswer: "20",
          },
          {
            id: "q04",
            question:
              "What is the maximum length for the pattern 'p' according to the constraints?",
            options: ["10", "20", "30", "40"],
            correctAnswer: "30",
          },
        ],
...
export const dummyStudentData = [
  {
    ...
    usn: "1RV21CS028",
    role: "student",
    email: "bhuvanrajt.cs21@rvce.edu.in",
    enrolledLabs: [
      {
